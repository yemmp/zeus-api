...
export class CreateFormularioDto {
    ...
    @ApiProperty({
        example:'2',
        description:'Número do índice do test-drive ao qual o formulário está atrelado.',
    })
    @IsNumber()
    codTestDrive: number;
    ...
    @ApiProperty({
        example:'4',
        description:'Número do índice da concessionaria a qual o formulário está atrelado.',
    })
    @IsNotEmpty()
    @IsNumber()
